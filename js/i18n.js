...
(function(CZ) {
    ...
    const DICT = {
        id: {
            ...
            ctxBroken: '(RUSAK)',
            ctxCopyKwh: 'Salin kWh',
            ctxResetKwh: 'Reset kWh → 0',
    ...
    const COMP_NAMES = {
        ...
        charge_controller: 'CC PWM 10A',
        charge_controller_30a: 'CC PWM 30A',
        charge_controller_60a: 'CC MPPT 60A',
        charge_controller_100a: 'CC MPPT 100A',
